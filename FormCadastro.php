        ...
        <div class="row">
            <div class="col-sm-6 col-sm-offset-3 custom-form">
                ...
                <form method="post" action="inserir_membro.php" name="logon">
                    ...
                    <div class="form-group">
                        <label for="sltgen">Escolha sua unidade</label>
                        <select class="form-control" name="sltcat">
                            <option value="">Selecione</option>
                            <?php while ($ListaUnidade = $consultaUnidade->fetch(PDO::FETCH_ASSOC)) { ?>
                                <option value="<?php echo $ListaUnidade['id_unidade']; ?>"><?php echo $ListaUnidade['nm_unidade']; ?></option>
                            <?php } ?>
                        </select>
                    </div>
                    <div class="form-group">
